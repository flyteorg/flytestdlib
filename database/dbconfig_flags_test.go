	...
	t.Run("Test_host", func(t *testing.T) {
		...
		t.Run("Override", func(t *testing.T) {
			...
			if vString, err := cmdFlags.GetString("host"); err == nil {
				testDecodeJson_DbConfig(t, fmt.Sprintf("%v", vString), &actual.DeprecatedHost)
	...
	t.Run("Test_port", func(t *testing.T) {
		...
		t.Run("Override", func(t *testing.T) {
			...
			if vInt, err := cmdFlags.GetInt("port"); err == nil {
				testDecodeJson_DbConfig(t, fmt.Sprintf("%v", vInt), &actual.DeprecatedPort)
	...
	t.Run("Test_dbname", func(t *testing.T) {
		...
		t.Run("Override", func(t *testing.T) {
			...
			if vString, err := cmdFlags.GetString("dbname"); err == nil {
				testDecodeJson_DbConfig(t, fmt.Sprintf("%v", vString), &actual.DeprecatedDbName)
	...
	t.Run("Test_username", func(t *testing.T) {
		...
		t.Run("Override", func(t *testing.T) {
			...
			if vString, err := cmdFlags.GetString("username"); err == nil {
				testDecodeJson_DbConfig(t, fmt.Sprintf("%v", vString), &actual.DeprecatedUser)
	...
	t.Run("Test_password", func(t *testing.T) {
		...
		t.Run("Override", func(t *testing.T) {
			...
			if vString, err := cmdFlags.GetString("password"); err == nil {
				testDecodeJson_DbConfig(t, fmt.Sprintf("%v", vString), &actual.DeprecatedPassword)
	...
	t.Run("Test_passwordPath", func(t *testing.T) {
		...
		t.Run("Override", func(t *testing.T) {
			...
			if vString, err := cmdFlags.GetString("passwordPath"); err == nil {
				testDecodeJson_DbConfig(t, fmt.Sprintf("%v", vString), &actual.DeprecatedPasswordPath)
	...
	t.Run("Test_options", func(t *testing.T) {
		...
		t.Run("Override", func(t *testing.T) {
			...
			if vString, err := cmdFlags.GetString("options"); err == nil {
				testDecodeJson_DbConfig(t, fmt.Sprintf("%v", vString), &actual.DeprecatedExtraOptions)
	...
	t.Run("Test_debug", func(t *testing.T) {
		...
		t.Run("Override", func(t *testing.T) {
			...
			if vBool, err := cmdFlags.GetBool("debug"); err == nil {
				testDecodeJson_DbConfig(t, fmt.Sprintf("%v", vBool), &actual.DeprecatedDebug)
