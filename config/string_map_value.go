...
func NewStringMapValue(m *map[string]string) *stringMapValue {
...
func NewStringMapValueEmpty() *stringMapValue {
	return NewStringMapValue(&map[string]string{})
}
...
func (s stringMapValue) Value() map[string]string {
	return *s.value
}
