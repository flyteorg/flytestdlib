...
func (cfg Config) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.Bool(fmt.Sprintf("%v%v", prefix, "file.enabled"), defaultConfig.FileConfig.Enabled, "Set to true to enable the file exporter")
	...
	cmdFlags.Bool(fmt.Sprintf("%v%v", prefix, "jaeger.enabled"), defaultConfig.JaegerConfig.Enabled, "Set to true to enable the jaeger exporter")
